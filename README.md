# Car Rental Fleet & Booking Platform

End-to-end car rental platform developed with Django, enabling vehicle catalog filtering, rental contract drafting, mileage audits, payment gateways, and vehicle return inspection logs.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-django-car-rental.git
   cd masa-django-car-rental
   ```
